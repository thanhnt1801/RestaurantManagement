...
namespace QLNH_Client.Migrations
{
    ...
    [Migration("20230620094945_Add guest model1")]
    partial class Addguestmodel1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QLNH_Client.Models.Guest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QLNH_Client.Models.Guest", b =>
                {
                    b.HasOne("QLNH_Client.Models.User", "CreatedBy")
                        .WithMany("GuestCreator")
                    ...
                    b.HasOne("QLNH_Client.Models.User", "UpdatedBy")
                        .WithMany("GuestUpdator")
            ...
            modelBuilder.Entity("QLNH_Client.Models.User", b =>
                {
                    b.Navigation("GuestCreator");

                    b.Navigation("GuestUpdator");
